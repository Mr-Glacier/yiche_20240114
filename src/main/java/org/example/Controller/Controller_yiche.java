...
public class Controller_yiche {
    ...
    public Set<String> columneSet = new HashSet<>();
...
//        1.构建哈希Map
        ...
        columnMap.put("影音娱乐_后排多媒体屏幕亮度[nit]", "C_影音娱乐_后排多媒体屏幕亮度nit");
        ...
        columnMap.put("内部配置_仪表屏幕色彩[万色]", "C_内部配置_仪表屏幕色彩万色");
        ...
        columnMap.put("辅助/操控配置_后轮转向角度[°]", "C_辅助操控配置_后轮转向角度");
        ...
        columnMap.put("车机/互联_副驾屏幕亮度[nit]", "C_车机互联_副驾屏幕亮度nit");
...
//                1.构建空的BeanList
                    ArrayList<Bean_version_config0421> bean_version_configs_carList = new ArrayList<>();

                    JSONArray carList = Item_list.getJSONObject(0).getJSONArray("items").getJSONObject(0).getJSONArray("paramValues");

                    for (int i = 0; i < carList.size(); i++) {
                        Bean_version_config0421 bean_version_config = new Bean_version_config0421();
                    ...
                    for (int i = 0; i < Item_list.size(); i++) {
                        ...
                        if (title_one.equals("选配包") || title_one.equals("特色配置")) {
                            ...
                            for (int j = 0; j < title_one_Items.size(); j++) {
                                ...
                                String columnName = (title_one + "_" + title_two).replace(" ", "");
